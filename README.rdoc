...
It enables a ruby application to interact with BigBlueButton by calling ruby methods instead of HTTP requests making it a lot easier to
...
* 0.64: see the branch <tt>api-0.64</tt>. The last version with support to 0.64 is {version 0.0.10}[https://github.com/mconf/bigbluebutton-api-ruby/tree/v0.0.10]. It supports both 0.64 and 0.7.
...
Use these versions to be sure it will work. Other varieties of these rubies (e.g. ruby 1.9.3-p448) should work as well.
